var HeaderTag = document.getElementById('head');
...
$(document).ready(function () {
  $('header').on("mouseenter focus", function () {
    $('.nav_box').slideDown(function () {
      $('.main_nav').delay(10).show();
    });
  });
  $('section').on("mouseenter focus",function () {
    $('.main_nav').hide();
    $('.nav_box').delay(10).slideUp();
  });
});